...
- Validación del editor directo: compilación con tipos, 107 pruebas unitarias superadas y siete pruebas de navegador de clasificación en Edge. Cubren edición y cancelación en fila, emojis, descripción, arrastre con ratón y tacto simulado, alternativa por teclado/toques, promoción a principal, orden persistente, rechazo de ciclos/duplicados y restauración de orden/emojis. Capturas de escritorio y 320 px revisadas; no se han ejecutado modelos reales ni probado un dispositivo táctil físico.
