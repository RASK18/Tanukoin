...
Se guardan dos fechas: **principal**, la menor entre las disponibles en cada operación, y **secundaria**, la mayor. Se examinan operación/inicio, valor, contabilización y finalización según las columnas del archivo, sin guardarlas como cuatro campos separados. Si solo existe una fecha, la secundaria queda vacía; si dos fechas coinciden se conserva esa coincidencia. Estos nombres expresan una preferencia de presentación, no certifican cuándo comenzó la compra o llegó el dinero. Los saldos siguen siendo los del extracto. La fecha principal no determina la posición: la secuencia puede contener pequeños retrocesos de fecha.
