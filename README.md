...
En Categorías se editan nombre, emoji y color directamente en cada fila, con Guardar y Descartar. El botón + Hija abre una fila nueva bajo su padre; Nueva categoría crea una principal. Solo la descripción para la IA se edita en un diálogo. El selector de emojis incluye búsqueda local y los iconos anteriores se muestran con su emoji equivalente. Arrastra el asa para colocar una categoría antes, después o dentro de otra, o sobre la zona de categorías principales. También puedes pulsar el asa y elegir un destino con teclado o toques. El orden se conserva al recargar y en las copias.
