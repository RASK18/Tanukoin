...
export const helpTopics = {
  ...
  categories:
    "En Categorías puedes organizar un árbol de profundidad libre. Edita nombre, emoji y color en la fila y pulsa Guardar. + Hija crea una hija sin modal. Arrastra el asa para ordenar: verás un hueco moverse entre las filas. Mueve a los lados para cambiar de nivel y a la izquierda para hacerla principal. Con teclado, Espacio inicia, las flechas ordenan o cambian de nivel, Enter guarda y Escape cancela. El botón IA abre la descripción. Cada movimiento admite una categoría, incluso una que tenga hijas. Busca por nombre y selecciona su ruta completa. En Etiquetas puedes crear, renombrar y eliminar agrupaciones independientes. Cada movimiento admite varias etiquetas; puedes crearlas al editarlo y añadirlas o quitarlas en lote. Eliminar una categoría elimina toda su rama y sus reglas y deja los movimientos sin categoría, previa confirmación del alcance. Eliminar una etiqueta solo retira sus asignaciones. Las categorías manuales se respetan; después se aplican reglas y finalmente sugerencias de IA local.",
